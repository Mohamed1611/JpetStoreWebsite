...
public class BaseTest {
	...
	public static WebDriver initializeDriver() throws IOException {
		...
		FileInputStream fis = new FileInputStream(
				System.getProperty("user.dir") + "//src//main//java//jpetStore//resources//GlobalData.properties");
		prop.load(fis);
		...
		if (browserName.equalsIgnoreCase("chrome")) {
			...
			// "/users/mohammedsamir/Documents/chromedriver");
			driver = new ChromeDriver();

		} else if (browserName.equalsIgnoreCase("firefox")) {

			// System.setProperty("webdriver.gecko.driver",
			// "/users/mohammedsamir/Documents/geckodriver");
			driver = new FirefoxDriver();
		} else if (browserName.equalsIgnoreCase("edge")) {

			// System.setProperty("webdriver.edge.driver",
			// "/users/mohammedsamir/Documents/msedgedriver");
